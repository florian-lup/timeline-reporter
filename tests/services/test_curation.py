...
class TestDecisionService:
    ...
    def test_curate_leads_basic(self, mock_openai_client, sample_leads, sample_ai_response):
    ...
    def test_curate_leads_formats_leads_correctly(self, mock_openai_client, sample_leads):
    ...
    def test_curate_leads_logging(self, mock_logger, mock_openai_client, sample_leads, sample_ai_response):
        ...
        expected_context_0 = sample_leads[0].context[:50] + "..." if len(sample_leads[0].context) > 50 else sample_leads[0].context
