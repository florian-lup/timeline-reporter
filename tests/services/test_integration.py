    ...
    def test_complete_pipeline_success(self, mock_clients, test_discovery_instructions):
        ...
        research_responses = [
            json.dumps({
                ...
                "sources": ["https://example.com/climate-summit", "https://example.com/climate-targets"]
            }),
            json.dumps({
                ...
                "sources": ["https://example.com/ai-healthcare", "https://example.com/medical-ai"]
            })
        ]
        ...
        mock_clients['mongodb'].insert_article.side_effect = [
            "60a1b2c3d4e5f6789", "60a1b2c3d4e5f6790",  # TTS service calls
            "60a1b2c3d4e5f6791", "60a1b2c3d4e5f6792"   # Storage service calls
        ]
