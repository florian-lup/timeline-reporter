...
class TestWritingService:
    ...
    def sample_researched_leads(self):
        ...
        return [
            Lead(
                ...
                "technologies, and climate finance for developing nations. Key participants "
                "include the US President, EU leaders, and representatives from major "
                "developing economies. The summit aims to establish binding commitments "
                "for carbon reduction by 2030.",
                sources=[
            ...
            Lead(
                ...
                context="The annual Tech Innovation Expo showcased groundbreaking AI "
                "developments from major technology companies. Key announcements included "
                "advances in natural language processing, autonomous vehicle technology, "
                "and medical diagnostic AI. Companies demonstrated AI systems capable of "
                "real-time language translation and breakthrough cancer detection algorithms. "
                "The expo highlighted the growing integration of AI in daily life and "
                "raised important questions about ethics and regulation.",
                sources=[
        ...
        return json.dumps(
            {
                ...
                "summary": "The Climate Summit 2024 has concluded with unprecedented "
                "cooperation between world leaders from 190 countries, establishing "
                "binding commitments to reduce carbon emissions by 50% before 2030. "
                "The summit addressed critical climate finance for developing nations "
                "and accelerated renewable energy transition plans.",
                "body": "The Climate Summit 2024 has concluded with historic agreements "
                "that mark a turning point in global climate action. World leaders from "
                "over 190 countries gathered to address the escalating climate crisis "
                "with unprecedented urgency and cooperation.\n\nThe summit's primary "
                "achievement was establishing binding commitments for carbon reduction "
                "by 2030, with developed nations pledging to cut emissions by 50%. "
                "Major discussions centered on renewable energy transition, carbon "
                "capture technologies, and crucial climate finance for developing "
                "nations.\n\nKey participants, including the US President and EU "
                "leaders, emphasized the critical importance of limiting global warming "
                "to 1.5°C. The agreements reached represent the most comprehensive "
                "climate action plan in recent history, with implementation beginning "
                "immediately.",
            }
        )
    ...
    def test_write_stories_prompt_formatting(
        ...
        assert "https://example.com" not in prompt  # Sources should not be in prompt
    ...
    def test_write_stories_json_parsing(self, mock_openai_client, sample_researched_leads):
        ...
        stories = write_stories(
            sample_researched_leads[:1], openai_client=mock_openai_client
        )
    ...
    def test_write_stories_json_parse_error(
